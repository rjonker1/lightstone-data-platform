...
namespace Application.MainModule.Tests
{
    ...
    public class SalesManagementServiceTests
    {
        ...
        {
            //Arrange
            var orderService = IoCFactory.Instance.CurrentContainer.Resolve<ISalesManagementService>();
        ...
        public void FindOrdersByDates_Invoke_test()
        {
            //Arrange
            var orderService = IoCFactory.Instance.CurrentContainer.Resolve<ISalesManagementService>();
            var initDate = new DateTime(2001, 1, 1);
        ...
        public void FindOrdersByShippingData_Invoke_test()
        {
            //Arrange
            var orderService = IoCFactory.Instance.CurrentContainer.Resolve<ISalesManagementService>();
            var initDate = new DateTime(2010, 1, 1);
            var endDate = new DateTime(2010, 5, 1);
        ...
        {
            //Arrange
            var productService = IoCFactory.Instance.CurrentContainer.Resolve<ISalesManagementService>();
            //Act
