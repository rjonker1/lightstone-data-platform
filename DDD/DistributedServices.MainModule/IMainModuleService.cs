...
namespace LightstoneApp.DistributedServices.MainModule
{
    ...
    [ServiceContract(Name = "IMainModuleService",
        Namespace = "LightstoneApp.DistributedServices.MainModuleService"
    ...
    public interface IMainModuleService
    {
        ...
        /// <returns>
        ///     Customer requested or null if not exist customer with code equals to <paramref name="customerCode" />
        /// </returns>
