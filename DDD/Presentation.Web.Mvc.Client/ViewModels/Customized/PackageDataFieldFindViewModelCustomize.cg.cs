...
{
    public partial class PackageDataFieldFindViewModel
    {
                ...
                else
                {
                    ...
                    DataFields =
                        _serviceDataField.GetAll(null, null)
                            ...
                            .ToList();
                    DataFields.Insert(0, new SelectListItem {Text = string.Empty, Value = string.Empty});
                    ...
                    Packages =
                        _servicePackage.GetAll(null, null)
                            .Select(
                                x => new SelectListItem {Text = Convert.ToString(x.Id), Value = Convert.ToString(x.Id)})
                            .ToList();
                    Packages.Insert(0, new SelectListItem {Text = string.Empty, Value = string.Empty});
