...
namespace LightstoneApp.Infrastructure.Data.PackageBuilder.Tests
{
    ...
    public class UnitTestPackageBuilderFactory
    {
        ...
        {
            var idNameDescTup = new List<Tuple<Guid, string, string, Guid>>
            {
                new Tuple<Guid, string, string, Guid>(
            ...
            foreach (var tuple in idNameDescTup)
            {
                ...
                var dtCreated = DateTime.Parse("21 Oct 2014");

                var packageCount = db.Packages.Count(x => x.Created == dtCreated);
