...
namespace LightstoneApp.Domain.Core.Tests
{
    ...
    public class SpecificationTests
    {
        ...
        public void AndSpecification_Creation_Test()
        {
            ...
            //Act
            var composite = new AndSpecification<TEntity>(leftAdHocSpecification, rightAdHocSpecification);
        ...
        public void OrSpecification_Creation_Test()
        {
            ...
            //Act
            var composite = new OrSpecification<TEntity>(leftAdHocSpecification, rightAdHocSpecification);
        ...
        public void AndSpecification_Creation_NullLeftSpecThrowArgumentNullException_Test()
        {
            ...
            //Act
            var composite = new AndSpecification<TEntity>(null, rightAdHocSpecification);
        }
        ...
        public void AndSpecification_Creation_NullRightSpecThrowArgumentNullException_Test()
        {
            ...
            //Act
            var composite = new AndSpecification<TEntity>(leftAdHocSpecification, null);
        }
        ...
        public void OrSpecification_Creation_NullLeftSpecThrowArgumentNullException_Test()
        {
            ...
            //Act
            var composite = new OrSpecification<TEntity>(null, rightAdHocSpecification);
        }
        ...
        public void OrSpecification_Creation_NullRightSpecThrowArgumentNullException_Test()
        {
            ...
            //Act
            var composite = new OrSpecification<TEntity>(leftAdHocSpecification, null);
        }
        ...
        public void Specification_AndOperator_Test()
        {
            ...
            expected = Expression.Lambda<Func<TEntity, bool>>(Expression.AndAlso(leftSpec.Body, invokedExpr),
                leftSpec.Parameters);
        ...
        public void Specification_OrOperator_Test()
        {
            ...
            InvocationExpression invokedExpr = Expression.Invoke(rightSpec, leftSpec.Parameters.Cast<Expression>());
            expected = Expression.Lambda<Func<TEntity, bool>>(Expression.Or(leftSpec.Body, invokedExpr),
                leftSpec.Parameters);
        ...
        public void NotSpecification_Creation_WithSpecification_Test()
        {
            ...
            var specification = new DirectSpecification<TEntity>(specificationCriteria);

            //Act
            var notSpec = new NotSpecification<TEntity>(specification);
            var resultCriteria =
                new PrivateObject(notSpec).GetField("_OriginalCriteria") as Expression<Func<TEntity, bool>>;
        ...
        public void NotSpecification_Creation_WithCriteria_Test()
        {
            ...
            //Act
            var notSpec = new NotSpecification<TEntity>(specificationCriteria);
        ...
        public void NotSpecification_Creation_FromNegationOperator()
        {
            ...
            //Act
            var spec = new DirectSpecification<TEntity>(specificationCriteria);
