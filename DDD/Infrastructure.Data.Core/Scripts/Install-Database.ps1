<#
.SYNOPSIS 
 Creates the database objects for the LightstoneApp application, optionally creating the database and a login for the NETWORK SERVICE user.
.EXAMPLE
...
# The database name. The default value is 'conference'.
    [string] $DatabaseName = "LightstoneAppDatabase",
