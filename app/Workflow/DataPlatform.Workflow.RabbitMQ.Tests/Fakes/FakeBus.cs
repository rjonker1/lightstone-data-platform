...
namespace DataPlatform.Workflow.RabbitMQ.Tests.Fakes
{
    public class FakeBus : IBus
    {
        ...
        public IDisposable Subscribe<T>(string subscriptionId, Action<T> onMessage,
        ...
        public IDisposable SubscribeAsync<T>(string subscriptionId, Func<T, Task> onMessage,
                                             Action<ISubscriptionConfiguration> configure) where T : class
        {
            throw new NotImplementedException();
        }
