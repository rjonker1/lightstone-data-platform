...
namespace PackageBuilder.Api.CannedData
{
    ...
    public class RolePackageCannedRepository : CannedRepository<IRolePackage>, IRolePackageRepository
    {
        public RolePackageCannedRepository()
        {
            Add(new RolePackage(Guid.NewGuid(), null, null, null, new DateTime()));
        }
