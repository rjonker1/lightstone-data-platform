...
namespace PackageBuilder.Api.Helpers.AutoMappers
{
    public class VehicleValuationResponseMap : ICreateAutoMapperMaps
    {
        public void CreateMaps()
        {
            ...
            Mapper.CreateMap<IEnumerable<IRespondWithAmortisationFactorModel>, IDataField>().ConvertUsing(s => new DataField(s.GetType().Name, s.GetType(), ToDataFields(s)));
            ...
            #endregion
            #region AreaFactors
            Mapper.CreateMap<IEnumerable<IRespondWithAreaFactorModel>, IDataField>().ConvertUsing(s => new DataField(s.GetType().Name, s.GetType(), ToDataFields(s)));
            ...
            Mapper.CreateMap<IEnumerable<IRespondWithAuctionFactorModel>, IDataField>().ConvertUsing(s => new DataField(s.GetType().Name, s.GetType(), ToDataFields(s)));
            ...
            Mapper.CreateMap<IEnumerable<IRespondWithAccidentDistributionModel>, IDataField>().ConvertUsing(s => new DataField(s.GetType().Name, s.GetType(), ToDataFields(s)));
            ...
            #endregion
            #region RepairIndex
            Mapper.CreateMap<IEnumerable<IRespondWithRepairIndexModel>, IDataField>().ConvertUsing(s => new DataField(s.GetType().Name, s.GetType(), ToDataFields(s)));
            ...
            Mapper.CreateMap<IEnumerable<IRespondWithTotalSalesByAgeModel>, IDataField>().ConvertUsing(s => new DataField(s.GetType().Name, s.GetType(), ToDataFields(s)));
            ...
            Mapper.CreateMap<IEnumerable<IRespondWithTotalSalesByGenderModel>, IDataField>().ConvertUsing(s => new DataField(s.GetType().Name, s.GetType(), ToDataFields(s)));
            ...
            Mapper.CreateMap<IEnumerable<IRespondWithEstimatedValueModel>, IDataField>().ConvertUsing(s => new DataField(s.GetType().Name, s.GetType(), ToDataFields(s)));
            ...
            Mapper.CreateMap<IEnumerable<IRespondWithSaleModel>, IDataField>().ConvertUsing(s => new DataField(s.GetType().Name, s.GetType(), ToDataFields(s)));
            Mapper.CreateMap<IRespondWithSaleModel, IEnumerable<IDataField>>().ConvertUsing(Mapper.Map<object, IEnumerable<IDataField>>);
            #endregion
            #region Prices
            Mapper.CreateMap<IEnumerable<IRespondWithPriceModel>, IDataField>().ConvertUsing(s => new DataField(s.GetType().Name, s.GetType(), ToDataFields(s)));
            Mapper.CreateMap<IRespondWithPriceModel, IEnumerable<IDataField>>().ConvertUsing(Mapper.Map<object, IEnumerable<IDataField>>);
            #endregion
            #region Frequency
            Mapper.CreateMap<IEnumerable<IRespondWithFrequencyModel>, IDataField>().ConvertUsing(s => new DataField(s.GetType().Name, s.GetType(), ToDataFields(s)));
            Mapper.CreateMap<IRespondWithFrequencyModel, IEnumerable<IDataField>>().ConvertUsing(Mapper.Map<object, IEnumerable<IDataField>>);
            #endregion
            #region Confidence
            Mapper.CreateMap<IEnumerable<IRespondWithConfidenceModel>, IDataField>().ConvertUsing(s => new DataField(s.GetType().Name, s.GetType(), ToDataFields(s)));
            ...
            Mapper.CreateMap<IEnumerable<IRespondWithAmortisedValueModel>, IDataField>().ConvertUsing(s => new DataField(s.GetType().Name, s.GetType(), ToDataFields(s)));
            ...
            #endregion
            #region ImageGauges
            Mapper.CreateMap<IEnumerable<IRespondWithImageGaugeModel>, IDataField>().ConvertUsing(s => new DataField(s.GetType().Name, s.GetType(), ToDataFields(s)));
