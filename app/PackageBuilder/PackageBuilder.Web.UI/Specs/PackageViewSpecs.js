...
///<reference path="~/App/packages/packageView.js"/>

describe('Controller: packageView', function () {
    ...
    //Specs
    it('should set the title to: "Package Maintenance - View"', function () {
        expect(scope.title).toEqual('Package Maintenance - View');
    });
