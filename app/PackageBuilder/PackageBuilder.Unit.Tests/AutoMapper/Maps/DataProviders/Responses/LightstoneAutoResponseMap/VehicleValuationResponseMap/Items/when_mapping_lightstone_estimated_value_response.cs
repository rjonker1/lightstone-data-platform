...
namespace PackageBuilder.Unit.Tests.AutoMapper.Maps.DataProviders.Responses.LightstoneAutoResponseMap.VehicleValuationResponseMap.Items
{
    public class when_mapping_lightstone_estimated_value_response : BaseTestHelper
    {
        ...
        {
            _dataField = Mapper.Map<IRespondWithEstimatedValueModel, IEnumerable<DataField>>(LightstoneAutoResponseMother.Response.VehicleValuation.EstimatedValue.First());
        }
