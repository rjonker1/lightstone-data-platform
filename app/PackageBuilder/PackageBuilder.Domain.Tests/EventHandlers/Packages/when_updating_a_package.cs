...
namespace PackageBuilder.Domain.Tests.EventHandlers.DataProviders
{
    public class when_updating_a_package : Specification
    {
        ...
        {
            var command = new PackageUpdated(Guid.NewGuid(), "VVi", "VVi", 10d, 20d, "Notes", new[] { IndustryMother.Automotive }, StateMother.Published, 1, 0.1m, "Owner", DateTime.Now, null, new[] { DataProviderOverrideMother.Ivid });
