...
namespace PackageBuilder.Domain.Tests.EventHandlers.DataProviders
{
    public class when_updating_a_data_provider : Specification
    {
        ...
        {
            var command = new DataProviderUpdated(Guid.NewGuid(), DataProviderName.Ivid, "Ivid", 10d, typeof(IProvideDataFromIvid), false, 1, "Owner", DateTime.Now, null, new []{ DataFieldMother.LicenseField });
