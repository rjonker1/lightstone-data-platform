...
namespace PackageBuilder.Domain.Tests.EventHandlers.DataProviders
{
    public class when_creating_a_data_provider : Specification
    {
        ...
        {
            var command = new DataProviderCreated(Guid.NewGuid(), DataProviderName.Ivid, "Ivid", 10d, typeof(IProvideDataFromIvid), "Owner", DateTime.Now, new []{ DataFieldMother.LicenseField });
