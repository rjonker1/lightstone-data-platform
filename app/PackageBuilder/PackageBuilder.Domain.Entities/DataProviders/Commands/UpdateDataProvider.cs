...
namespace PackageBuilder.Domain.Entities.DataProviders.Commands
{
    public class UpdateDataProvider : IDomainCommand
    {
        ...
        public UpdateDataProvider(Guid id, Guid dataProviderId, string name, string owner, DateTime created, DateTime edited, int version, Type dataProviderType, IEnumerable dataFields)
        {
            Id = id;
