...
{
    class when_loading_data_provider_detail_page
    {
        ...
        public void should_set_field_table_title()
        {
            ...
            Assert.AreEqual("Data Provider Detail : Request - Data Fields", dataProvidersPage.FindByIdWithAttribute("field_table_title", "title"));
        }
        ...
        public void should_set_connection_details()
        {
            ...
            Assert.AreEqual("Data Provider Detail : Response", dataProvidersPage.FindByIdWithAttribute("connection_details", "title"));
        }
