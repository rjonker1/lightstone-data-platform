...
{
    public class when_mapping_rgt_vin_response : Specification
    {
        public override void Observe()
        {
            ...
            var test = Mapper.Map<IProvideDataFromRgtVin, IEnumerable<IDataField>>(RgtVinResponseMother.Response);
        }
