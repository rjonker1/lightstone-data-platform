    ...
    internal class DataProviderRequestTypeMapper : TypeMapper
    {
        ...
        protected override IEnumerable<string> FieldNames
        {
            get
            {
                return new[]
                {
                    "Id", "Date", "RequestId", "DataProvider", "DataProviderName", "ConnectionType", "Connection"
                };
            }
        }
        ...
        public override object Get(System.Data.IDbConnection connection, Guid id)
        {
            ...
            return match == null
                ? null
                : new DataProviderRequest(new DataProviderRequestIdentifier(match.Id,match.Date, 
