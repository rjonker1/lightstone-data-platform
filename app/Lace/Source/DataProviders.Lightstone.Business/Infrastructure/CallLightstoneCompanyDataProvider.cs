...
namespace Lace.Domain.DataProviders.Lightstone.Business.Company.Infrastructure
{
    ...
    {
        private static readonly ILog Log = LogManager.GetLogger<CallLightstoneBusinessCompanyDataProvider>();
        ...
        public void CallTheDataProvider(ICollection<IPointToLaceProvider> response)
        {
            ...
            {
                Log.ErrorFormat("Error calling Lightstone Business Data Provider {0}", ex, ex.Message);
