...
namespace Lace.Domain.DataProviders.Ivid.IvidServiceReference {
    ...
    public interface HpiService {
        ...
        Lace.Domain.DataProviders.Ivid.IvidServiceReference.HpiStandardQueryResponse1 HpiStandardQuery(Lace.Domain.DataProviders.Ivid.IvidServiceReference.HpiStandardQueryRequest1 request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<Lace.Domain.DataProviders.Ivid.IvidServiceReference.HpiStandardQueryResponse1> HpiStandardQueryAsync(Lace.Domain.DataProviders.Ivid.IvidServiceReference.HpiStandardQueryRequest1 request);
    }
    ...
    public partial class HpiStandardQueryRequest1 {
        ...
        public Lace.Domain.DataProviders.Ivid.IvidServiceReference.HpiStandardQueryRequest HpiStandardQueryRequest;
        
        public HpiStandardQueryRequest1() {
        }
        
        public HpiStandardQueryRequest1(Lace.Domain.DataProviders.Ivid.IvidServiceReference.HpiStandardQueryRequest HpiStandardQueryRequest) {
    ...
    public partial class HpiStandardQueryResponse1 {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://www.ubiquitech.co.za/schemas/ivid/hpiService/", Order=0)]
        public Lace.Domain.DataProviders.Ivid.IvidServiceReference.HpiStandardQueryResponse HpiStandardQueryResponse;
        
        public HpiStandardQueryResponse1() {
        }
        
        public HpiStandardQueryResponse1(Lace.Domain.DataProviders.Ivid.IvidServiceReference.HpiStandardQueryResponse HpiStandardQueryResponse) {
            this.HpiStandardQueryResponse = HpiStandardQueryResponse;
        }
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface HpiServiceChannel : Lace.Domain.DataProviders.Ivid.IvidServiceReference.HpiService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class HpiServiceClient : System.ServiceModel.ClientBase<Lace.Domain.DataProviders.Ivid.IvidServiceReference.HpiService>, Lace.Domain.DataProviders.Ivid.IvidServiceReference.HpiService {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Lace.Domain.DataProviders.Ivid.IvidServiceReference.HpiStandardQueryResponse1 Lace.Domain.DataProviders.Ivid.IvidServiceReference.HpiService.HpiStandardQuery(Lace.Domain.DataProviders.Ivid.IvidServiceReference.HpiStandardQueryRequest1 request) {
            return base.Channel.HpiStandardQuery(request);
        }
        
        public Lace.Domain.DataProviders.Ivid.IvidServiceReference.HpiStandardQueryResponse HpiStandardQuery(Lace.Domain.DataProviders.Ivid.IvidServiceReference.HpiStandardQueryRequest HpiStandardQueryRequest) {
            Lace.Domain.DataProviders.Ivid.IvidServiceReference.HpiStandardQueryRequest1 inValue = new Lace.Domain.DataProviders.Ivid.IvidServiceReference.HpiStandardQueryRequest1();
            inValue.HpiStandardQueryRequest = HpiStandardQueryRequest;
            Lace.Domain.DataProviders.Ivid.IvidServiceReference.HpiStandardQueryResponse1 retVal = ((Lace.Domain.DataProviders.Ivid.IvidServiceReference.HpiService)(this)).HpiStandardQuery(inValue);
            return retVal.HpiStandardQueryResponse;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<Lace.Domain.DataProviders.Ivid.IvidServiceReference.HpiStandardQueryResponse1> Lace.Domain.DataProviders.Ivid.IvidServiceReference.HpiService.HpiStandardQueryAsync(Lace.Domain.DataProviders.Ivid.IvidServiceReference.HpiStandardQueryRequest1 request) {
            return base.Channel.HpiStandardQueryAsync(request);
        }
        
        public System.Threading.Tasks.Task<Lace.Domain.DataProviders.Ivid.IvidServiceReference.HpiStandardQueryResponse1> HpiStandardQueryAsync(Lace.Domain.DataProviders.Ivid.IvidServiceReference.HpiStandardQueryRequest HpiStandardQueryRequest) {
            Lace.Domain.DataProviders.Ivid.IvidServiceReference.HpiStandardQueryRequest1 inValue = new Lace.Domain.DataProviders.Ivid.IvidServiceReference.HpiStandardQueryRequest1();
            inValue.HpiStandardQueryRequest = HpiStandardQueryRequest;
            return ((Lace.Domain.DataProviders.Ivid.IvidServiceReference.HpiService)(this)).HpiStandardQueryAsync(inValue);
        }
    }
}
