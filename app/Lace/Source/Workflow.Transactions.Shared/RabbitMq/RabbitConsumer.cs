...
namespace Workflow.Transactions.Shared.RabbitMq
{
    public class RabbitConsumer : IConsumeQueue, IDisposable
    {
        ...
        public void AddBindingToAQueue(IAmAQueue bindingToQueue, string queueName, string exchangeName,
            string routingKeyName, string exchangeType)
        {
        ...
        public void AddExchangeBindingToQueue(IAmAQueue bindingToQueue, string exchangeName,
