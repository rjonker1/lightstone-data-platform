...
namespace Lace.Domain.DataProviders.Bmw.Finance
{
    public sealed class BmwFinanceDataProvider : ExecuteSourceBase, IExecuteTheDataProviderSource
    {
        ...
        {
            var spec = new CanHandlePackageSpecification(DataProviderName.BmwFsTitle, _request);
            ...
            else
            {
                ...
                _dataProvider = _request.First().Package.DataProviders.Single(w => w.Name == DataProviderName.BmwFsTitle);
                _logCommand = LogCommandTypes.ForDataProvider(_command, DataProviderCommandSource.BmwFsTitle, _dataProvider);
