...
namespace Lace.Shared.Monitoring.Messages.Shared
{
    public class SendAudatexCommands : ISendCommandsToBus
    {
        ...
        private DataProviderCommandEnvelope Begin(object payload, MetadataContainer metadata)
        {
            var command = new
            {
                AudatexExcutionHasStarted = new
                {
                    AudatexExcutionHasStarted =
                        new AudatexExcutionHasStarted(_requestId, DataProviderCommandSource.Audatex,
        ...
        private DataProviderCommandEnvelope End(object payload, MetadataContainer metadata)
        {
            var command = new
            {
                AudatexExcutionHasEnded = new
                {
                    AudatexExcutionHasEnded =
                        new AudatexExcutionHasEnded(_requestId, DataProviderCommandSource.Audatex,
        ...
        private DataProviderCommandEnvelope Transformation(dynamic payload, MetadataContainer metadata)
        {
            var command = new
            {
                AudatexResponseTransformed = new
                {
                    AudatexResponseTransformed = new AudatexResponseTransformed(_requestId, DataProviderCommandSource.Audatex,
