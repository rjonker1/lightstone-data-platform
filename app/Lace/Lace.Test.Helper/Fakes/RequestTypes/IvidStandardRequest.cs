...
namespace Lace.Test.Helper.Fakes.RequestTypes
{
    public class IvidStandardRequest : IAmIvidStandardRequest
    {
        ...
        //public static IAmIvidStandardRequest WithVin(string vinNumber, string applicantName, string packageName, string requestorEmail, string requestorName, string requestorPhone)
        //{
        //    return new IvidStandardRequest()
        //    {
