...
namespace Lace.Test.Helper.Builders.EzScore
{
    public class PCubedEzScoreSourcePackage
    {
        ...
        public class PCubedEzScorePackage : IHavePackageForRequest
        {
            ...
            {
                get { return new IAmDataProvider[] { new DataProvider(DataProviderName.PCubedEZScore_E_WS, 50, 27, PCubedEzScoreRequest.WithDefault(_emailAddress, _idNumber, _phoneNumber), new BillableState(DataProviderNoRecordState.Billable)) }; }
            }
