...
{
    public class LicensePlateNumberRgtOnlyRequest : IPointToLaceRequest
    {
        ...
        {
            get { return LicensePlateNumberRgtRequestPackage.LicenseNumberPackage(111525); }//  get { return LicensePlateNumberRgtRequestPackage.LicenseNumberPackage(112859); } //return LicensePlateNumberRgtRequestPackage.LicenseNumberPackage(112859);
        }
