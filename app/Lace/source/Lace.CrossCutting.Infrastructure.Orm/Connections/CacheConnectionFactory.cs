...
{
    public sealed class CacheConnectionFactory
    {
        private const string CacheIp = "127.0.0.1:6379";
        private static readonly PooledRedisClientManager _redisClient;

        public static PooledRedisClientManager LocalClient
        {
            get
            {
                return _redisClient ?? new PooledRedisClientManager(10000, 1000, new[] { CacheIp })
                {
