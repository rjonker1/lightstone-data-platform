...
namespace Lace.Acceptance.Tests.Workflow
{
    public class when_sending_request_for_data_provider_to_workflow_bus : Specification
    {
        ...
        public override void Observe()
        {
            try
            {
                new WorkflowCommandBuilder(_bus, _packageId, _contractId, _userId, _packageVersion, _requestId, _system, _accountNumber, _packageCostPrice, _packageRecommendedPrice)
                    .ForRequestReceived()
                    .Wait()
                    .ForIvidSecurity()
