...
{
    public class when_consuming_bmw_finance_with_vin_number : Specification
    {
        ...
        public when_consuming_bmw_finance_with_vin_number()
        {
        ...
        [Observation(Skip = "Not querable with only vin number yet")]
        ...
        public void bmw_finance_response_from_consumer_must_not_be_empty()
        {
            ...
            _response.OfType<IProvideDataFromBmwFinance>().First().Finances.First().RegistrationYear.ShouldEqual(2009);
        }
    }
}
