...
{
    public class when_initializing_car_id_chain_for_carid_and_year_search_on_ls_auto : Specification
    {
        ...
        public void lace_data_providers_accepting_car_id_should_have_responses()
        {
            ...
            _initialize.DataProviderResponses.OfType<IProvideDataFromRgt>().First().ResponseState.ShouldEqual(DataProviderResponseState.NoRecords);


            _initialize.DataProviderResponses.OfType<IProvideDataFromMmCode>().First().ShouldNotBeNull();
            _initialize.DataProviderResponses.OfType<IProvideDataFromMmCode>().First().Handled.ShouldBeFalse();
            _initialize.DataProviderResponses.OfType<IProvideDataFromMmCode>().First().ResponseState.ShouldEqual(DataProviderResponseState.NoRecords);
