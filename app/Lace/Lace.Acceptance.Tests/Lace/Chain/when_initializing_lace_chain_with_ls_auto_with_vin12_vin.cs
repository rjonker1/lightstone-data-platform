...
{
    public class when_initializing_lace_chain_with_ls_auto_with_vin12_vin : Specification
    {
        ...
        [Observation]
        public void lace_data_providers_vin12_must_be_handled_loaded_correclty()
        {
