...
namespace Lace.Acceptance.Tests.Requests
{
    public class when_sending_property_request_to_lace_entry_point : Specification
    {
        ...
        public when_sending_property_request_to_lace_entry_point()
        {
            ...
            _bus = new DataPlatform.Shared.Messaging.RabbitMQ.BusFactory("Monitoring.Messages.Commands", assembliesToScan, "DataPlatform.Monitoring.Host").CreateBusWithNHibernatePersistence();
        ...
        public void lace_request_to_be_loaded_and_responses_to_be_returned_for_property_sources()
        {
            ...
            _responses[0].Response.LightstonePropertyResponse.ShouldNotBeNull();
            _responses[0].Response.LightstonePropertyResponseHandled.Handled.ShouldBeTrue();
