...
namespace EventTracking.Domain.Read.Core
{
    public static class EventStoreConnectionExtensions
    {
        ...
        private static IEnumerable<T> ReadResult<T>(IEventStoreConnection connection, string streamName,
            int lastEventNumber)
        {
        ...
        private static StreamEventsSlice ReadStreamEventsBackwards(this IEventStoreConnection connection,
            string streamName, int lastEventNumber)
        {
