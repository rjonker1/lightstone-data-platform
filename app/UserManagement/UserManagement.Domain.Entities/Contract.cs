...
namespace UserManagement.Domain.Entities
{
    public class Contract : Entity
    {
        ...
        public Contract(Guid id, DateTime contractCommencementDate, string contractName, string lastUpdateBy, DateTime lastUpdateDate, string contactDetail, string enteredIntoBy, DateTime? onlineAcceptance, string registeredName, string registrationNumber, Client client, ContractType contractType, EscalationType escalationType, ContractDuration contractDuration) : base(id)
        {
