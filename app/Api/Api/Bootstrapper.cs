...
namespace Api
{
    public class Bootstrapper : WindsorNancyBootstrapper
    {
        ...
        protected override void ConfigureApplicationContainer(IWindsorContainer container)
        {
            ...
            container.Register(Component.For<IRouteDescriptionProvider>().ImplementedBy<ApiRouteDescriptionProvider>().LifestyleTransient());
            ...
            container.Register(Component.For<IBus>().Instance(new BusFactory("Monitoring.Messages.Commands", assembliesToScan, "DataPlatform.Monitoring.Host").CreateBus()));
            ...
            container.Register(Component.For<ICallDriversLicenseVerification>().ImplementedBy<DriversLicenseVerificationService>().LifestyleTransient());
            container.Register(Component.For<IHandleDriversLicenseVerficationRequests>().ImplementedBy<DriversLicenseVerificationHandler>().LifestyleTransient());
        }
    }
}