...
{
    public class when_sending_Lsp_request : Specification
    {
        ...
        public when_sending_Lsp_request()
        {
            _bootstrapper = new Bootstrapper();
            _browser = new Browser(_bootstrapper, defaults: to => to.Accept("application/xml"));
