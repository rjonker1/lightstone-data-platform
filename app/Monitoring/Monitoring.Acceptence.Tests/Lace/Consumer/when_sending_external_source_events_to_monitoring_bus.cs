...
{
    public class when_sending_external_source_events_to_monitoring_bus : Specification
    {
        ...
        [Observation]
        public void monitoring_lace_ivid_external_source_conumer_consumed_must_be_true()
        {
        ...
        [Observation]
        public void monitoring_lace_ivid_external_source_configuration_consumer_consumed_must_be_true()
        {
        ...
        [Observation]
        public void monitoring_lace_ivid_external_source_failed_consumer_consumed_must_be_true()
        {
        ...
        [Observation]
        public void monitoring_lace_ivid_external_source_handled_consumer_consumed_must_be_truee()
        {
        ...
        [Observation]
        public void monitoring_lace_ivid_external_source_no_response_received_consumer_consumed_must_be_true()
        {
        ...
        [Observation]
        public void monitoring_lace_ivid_external_source_response_received_consumer_consumed_must_be_true()
        {
        ...
        [Observation]
        public void monitoring_lace_ivid_external_source_request_sent_consumer_consumed_must_be_true()
        {
        ...
        [Observation]
        public void monitoring_lace_ivid_external_source_response_transformed_consumer_consumed_must_true()
        {
