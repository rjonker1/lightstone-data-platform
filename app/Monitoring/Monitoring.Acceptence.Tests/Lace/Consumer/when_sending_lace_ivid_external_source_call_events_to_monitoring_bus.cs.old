...
{
    public class when_sending_lace_ivid_external_source_call_events_to_monitoring_bus : Specification
    {
        ...
        public when_sending_lace_ivid_external_source_call_events_to_monitoring_bus()
        {
