...
namespace Lim.Schedule.Core.Commands
{
    ...
    {
        public AuditIntegrationCommand(long clientId, Guid configurationKey, DateTime date, IntegrationAction action, IntegrationType type, string address, string suffix)
        {
            ClientId = clientId;
